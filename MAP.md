...
- **高判空不等於判準保守，這件事已經被兩端夾住**。九章 99% 判空與列女傳 4% 判空（96% 命中、12／13）出自同一道閘門、同一發包管道、同一模型。**看到連續幾部判空率高時，先問是不是體裁，別急著鬆判準。****反向也一樣**：太玄經贊辭層命中 26% 高於同書玄傳層的 17%，抽樣查證兩側都判得對——測辭是太玄的「小象傳」，把位次翻譯成對人的斷語，這一層本來就承重。**遇到高命中率也是先問體裁，不是先懷疑判準鬆。**
