...
> 生成時間 2026-08-09T22:41:21+00:00｜3867 筆領域標記｜來自 19 部已標註的書

書級 `domains_hit` 只能告訴你去哪本書找；這裡直接給段落（SCHEMA §1.1）。

| 領域 | 名稱 | 命中段數 | 命中書數 | 通讀零命中書數 |
|---|---|---|---|---|
| [I](./domains/I.md) | 存在與意義 | 16 | 5 | 14 |
| [II](./domains/II.md) | 自我與認同 | 352 | 12 | 7 |
| [III](./domains/III.md) | 愛與親密 | 84 | 10 | 9 |
| [IV](./domains/IV.md) | 家庭與傳承 | 329 | 15 | 4 |
| [V](./domains/V.md) | 群體·社會·公義 | 1093 | 15 | 4 |
| [VI](./domains/VI.md) | 情緒與內在生活 | 255 | 9 | 10 |
| [VII](./domains/VII.md) | 善惡·良心·品格 | 744 | 13 | 6 |
| [VIII](./domains/VIII.md) | 工作·成就·召喚 | 416 | 15 | 4 |
| [IX](./domains/IX.md) | 苦難·疾病·身體 | 77 | 11 | 8 |
| [X](./domains/X.md) | 無常·老·死·失去 | 174 | 11 | 8 |
| [XI](./domains/XI.md) | 自由·命運·改變 | 150 | 8 | 11 |
| [XII](./domains/XII.md) | 信仰·神聖·超越 | 117 | 12 | 7 |
| [XIII](./domains/XIII.md) | 安頓·修復·平安 | 60 | 8 | 11 |

## 缺口報告

**未標註 53 部**——這些書的領域分佈目前是未知，不是零。上表任何一格的低數字都要先扣掉這批才有意義。

- `jinlouzi` 金樓子（人論，18 章，197,511 bytes）
- `cai-zhonglang-ji` 蔡中郎集（儒家著述，170 章，255,990 bytes）
- `duduan` 獨斷（儒家著述，36 章，36,623 bytes）
- `fengsu-tongyi` 風俗通義（儒家著述，85 章，132,190 bytes）
- `kongcongzi` 孔叢子（儒家著述，19 章，96,008 bytes）
- `shenjian` 申鑒（儒家著述，9 章，103,087 bytes）
- `sushu` 素書（儒家著述，6 章，4,961 bytes）
...
- `liutao` 六韜（兵家，66 章，64,772 bytes）
- `san-lue` 三略（兵家，3 章，14,860 bytes）
- `sima-fa` 司馬法（兵家，5 章，13,094 bytes）
- `weiliaozi` 尉繚子（兵家，20 章，18,016 bytes）
- `wuzi` 吳子（兵家，6 章，18,009 bytes）
...
- `jian-zhu-ke-shu` 諫逐客書（法家，1 章，2,989 bytes）
- `shangjunshu` 商君書（法家，25 章，73,476 bytes）
- `shenzi` 慎子（法家，9 章，25,740 bytes）
- `sunzi-suanjing` 孫子算經（算書，4 章，35,563 bytes）
- `zhoubi-suanjing` 周髀算經（算書，6 章，22,323 bytes）
- `chuci` 楚辭（術數，29 章，59,840 bytes）
...
- `xijing-zaji` 西京雜記（雜史，132 章，54,738 bytes）
- `yandanzi` 燕丹子（雜史，4 章，11,568 bytes）
- `yanzi-chunqiu` 晏子春秋（雜史，215 章，167,041 bytes）
- `yi-zhoushu` 逸周書（雜史，66 章，170,111 bytes）
...
- `yulizi` 郁離子（雜著，182 章，155,705 bytes）
