...
六次全文讀的錯法一致：都只往「補上漏標」修，沒有一次是預期標了而全文推翻。標註偏誤方向是穩定的低估（人物志漏掉 V 的 57 段；潛夫論預期 V 為主成立，但完全沒預期到 XII 有 32 段、IV 有 16 段，也沒預期到 I 會命中）。
...
## 待使用者決定（原兩條，第 2 條已於 2026-08-09 定案，剩第 1 條）
